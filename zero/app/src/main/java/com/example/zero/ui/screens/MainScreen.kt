...
fun MainScreen() {
    ...
    ModalNavigationDrawer(
        ...
        topBar = {
            ...
            when (currentRoute) {
                MainRoutes.WORK_ORDERS -> TechFlowBrandTopBar(title = "D&S Refrigerantes", onProfileClick = onProfClick)
                MainRoutes.EQUIPMENT -> TechFlowTopBar(title = "TechFlow", onNavigationClick = { onNavClick() }, onProfileClick = onProfClick)
                MainRoutes.HISTORY -> TechFlowBrandTopBar(title = "D&S Refrigerantes", onProfileClick = onProfClick)
                MainRoutes.ALERTS -> TechFlowTopBar(title = "D&S Refrigerantes", onNavigationClick = { onNavClick() }, onProfileClick = onProfClick)
